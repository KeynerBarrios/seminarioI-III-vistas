      ...
      <nav className="nav">
        <div className='nav__container'>
          ...
          <a href="#menu" className='nav__menu'>
            <img className='nav__icon' src="src/assets/akar-icons_gear.svg" alt="" />
          </a>

          <a href="#" className='nav__menu nav__icon--second'>
            <img className='nav__icon' src="src/assets/Back.svg" alt="" />
          </a>

          <ul className='dropdown' id='menu'>
            <div className='conteainer-menu'>
              <div className='icon-logo'>
                <img className='logo' src="src/assets/Vector_logo.svg" alt="" />
